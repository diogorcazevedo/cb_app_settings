...
use App\Http\Controllers\SiteAdmin\CollectionController;
...
Route::get('collection/index',                             [CollectionController::class, 'index'])->name('collection.index')->middleware(['auth', 'verified','check']);
Route::get('collection/create',                            [CollectionController::class, 'create'])->name('collection.create')->middleware(['auth', 'verified','check']);
Route::post('collection/store',                            [CollectionController::class, 'store'])->name('collection.store')->middleware(['auth', 'verified','check']);
Route::get('collection/edit/{id}',                         [CollectionController::class, 'edit'])->name('collection.edit')->middleware(['auth', 'verified','check']);
Route::post('collection/update/{id}',                      [CollectionController::class, 'update'])->name('collection.update')->middleware(['auth', 'verified','check']);
Route::get('collection/destroy/{id}',                      [CollectionController::class, 'destroy'])->name('collection.destroy')->middleware(['auth', 'verified','check']);

Route::get('collection/images/index/{id}',                 [CollectionController::class, 'images'])->name('collection.images.index')->middleware(['auth', 'verified','check']);
Route::post('collection/image/store/{id}',                 [CollectionController::class, 'imageStore'])->name('collection.image.store')->middleware(['auth', 'verified','check']);
Route::get('collection/image_destroy/{image}',             [CollectionController::class, 'imageDestroy'])->name('collection.image.destroy')->middleware(['auth', 'verified','check']);
Route::get('collection/image/download/{image}',            [CollectionController::class, 'download'])->name('collection.image.download')->middleware(['auth', 'verified','check']);
