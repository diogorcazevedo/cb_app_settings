...
export default function Edit( {subcategory}) {
    ...
    function submit(e) {
        e.preventDefault()
        post(route("subcategory.update",{subcategory:subcategory.id}));

    }
    function destruction() {
        if (confirm("Deseja realmente apagar este registro?")) {
            get(route("subcategory.destroy",{subcategory:subcategory.id}));
        }
    }
