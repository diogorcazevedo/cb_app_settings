...
export default function SlideEditGems({product,gems}) {

    const [open, setOpen] = useState(false)



    const products_gems = _.orderBy(product.gems, 'name', 'asc');
    const differences = _.differenceBy(gems, products_gems, 'id');
