...
export default function Images({collection,images,types}) {
    ...
    function submit(e) {
        e.preventDefault()
        post(route('collection.image.store',{id:collection.id}))
    }
                    ...
                    <div className="bg-white">
                        <div className="py-16 sm:py-24 lg:max-w-7xl lg:mx-auto lg:px-8">
                            <div className="px-4 flex items-center justify-between sm:px-6 lg:px-0">
                                <h2 className="py-6 px-4 text-xl tracking-tight text-gray-800 shadow">{collection.name}</h2>
                            </div>
                                        ...
                                        {images.map((image) => (
                                            <li key={image.id} className="w-64 inline-flex flex-col text-center lg:w-auto shadow p-6">
                                                ...
                                                <div className="mt-4 flex justify-between">
                                                    <div>
                                                        <Link
                                                            href={route('collection.image.destroy',{image:image.id})}
                                                    ...
                                                    <div>
                                                        <a
                                                            href={route('collection.image.download',{id:image.id})}
