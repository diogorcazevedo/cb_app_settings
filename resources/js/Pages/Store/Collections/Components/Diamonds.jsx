                ...
                <div className="pt-6">
                    <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                        <div className="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                            <Link href={route('store.collections_diamonds')}>
                            <img
                    ...
                    <div className="mx-auto max-w-7xl py-8 px-4 sm:py-8 sm:px-6 lg:px-8">
                        <div className="sm:flex sm:items-baseline sm:justify-between">
                            ...
                            <Link href={route('store.collections_diamonds')} className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
                                Saiba mais
